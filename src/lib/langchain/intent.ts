...
/** Intenciones que el asistente puede detectar (ej. desde WhatsApp). */
export const IntentSchema = z.object({
  ...
  datos_extraidos: z
    ...
    .optional()
    .describe("Datos útiles extraídos: nombre, teléfono, email, tipo de servicio, etc."),
});
 ...
 * Usa el LLM con structured output (Zod) para devolver intent, confianza y resumen.
 */
