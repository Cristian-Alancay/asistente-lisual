...
const paths = ["/dashboard", "/dashboard/experiencia"];
...
export async function updateSolicitudVideo(id: string, updates: { estado?: string; link_descarga?: string }) {
  const supabase = await createClient();
